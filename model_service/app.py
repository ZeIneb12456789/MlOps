...
def predict():
    try:
        ...
        try:
            ...
            intl_plan_encoded = encoders["International plan"].transform(
                [data["International_plan"]]
            )[0].item()
            voicemail_encoded = encoders["Voice mail plan"].transform(
        ...
        input_data = np.array([[
            ...
            data["Total_day_minutes"], data["Total_day_calls"],
            data["Total_day_charge"], data["Total_eve_minutes"],
            data["Total_eve_calls"], data["Total_eve_charge"],
        ...
        if model.n_features_in_ != input_data.shape[1]:
            abort(400, f"Model expects {model.n_features_in_} features, "
